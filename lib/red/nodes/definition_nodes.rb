    ...
    class Method < DefinitionNode # :nodoc:
      ...
      class Instance < Method # :nodoc:
        ...
        def initialize(function_name_sexp, scope_sexp, options)
          ...
          args_checker    = "$a(%s,%s,arguments,%s)" % [minimum_args, (splat_arg ? -1 : maximum_args), (splat_block || block_arg ? "bg?1:0" : "m$blockGivenBool(arguments[arguments.length-1])?1:0")] unless @@red_import
